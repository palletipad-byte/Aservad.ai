...
# 4. AI అడ్వాన్స్‌డ్ ఇమేజ్ జనరేటర్ (Hugging Face - Aservad.ai)
elif choice.startswith("4."):
    st.subheader("🎨 AI అల్ట్రా-హెచ్‌డీ ఇమేజ్ జనరేటర్ (Joshna Tailors & Aservad.ai)")
    st.info("మిత్రమా, ఇక్కడ మీకు కావలసిన డిజైన్, ఫ్యాషన్ లుక్ లేదా ఫోటో వివరాలను రాయండి. Hugging Face ద్వారా అద్భుతమైన ఇమేజ్ సృష్టిస్తుంది!")
        ...
        if user_img_prompt.strip():
            with st.spinner("⏳ అద్భుతమైన డిజైన్‌ను రూపం ఇస్తున్నాం... దయచేసి వేచి ఉండండి"):
                try:
                    ...
                    # Hugging Face API Endpoint (FLUX.1-schnell - ఉచితం మరియు వేగవంతమైనది)
                    API_URL = "https://api-inference.huggingface.co/models/black-forest-labs/FLUX.1-schnell"
                    
                    # మీ టోకెన్ నేరుగా ఇక్కడ సెట్ చేయబడింది
                    ...
                    if response.status_code == 200:
                        ...
                        st.image(image, caption="Generated by Aservad.ai & Hugging Face", use_column_width=True)
                    else:
                        st.warning(f"⚠️ మోడల్ ప్రస్తుతం లోడ్ అవుతోంది లేదా చిన్న సమస్య వచ్చింది. మరోసారి ప్రయత్నించండి! వివరాలు: {response.text}")

...
if choice == "1. Home / Dashboard":
    ...
    st.caption("ఉదాహరణ ప్రాంప్ట్: A futuristic city with flying cars, cinematic lighting, 8k")
    ...
    st.caption("ఉదాహరణ ప్రాంప్ట్: A peaceful forest with falling autumn leaves, slow motion")

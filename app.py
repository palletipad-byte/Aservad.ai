...
# 4. AI అడ్వాన్స్‌డ్ ఇమేజ్ జనరేటర్ (Aservad.ai Ultra-HD FLUX Engine - Final Master)
        ...
        if user_img_prompt.strip():
            with st.spinner("⏳ అద్భుతమైన డిజైన్‌ను అత్యున్నత నాణ్యతతో రూపం ఇస్తున్నాం... దయచేసి వేచి ఉండండి."):
                try:
                    ...
                    # 🎯 కార్టూన్ రాకుండా పూర్తిగా రియలిస్టిక్ ఫోటో కోసం బలమైన ట్యాగ్స్
                    base_prompt = f"Raw real-life photograph, {user_img_prompt}, sharp focus, real human skin texture, pores, professional studio lighting, 8k resolution, photorealistic masterpiece, no cartoon, no illustration."
                    encoded_prompt = urllib.parse.quote(base_prompt)
                    
                    # 📱 మొబైల్ స్క్రీన్ కోసం పర్ఫెక్ట్ 9:16 వర్టికల్ సైజు
                    img_url = f"https://image.pollinations.ai/prompt/{encoded_prompt}?width=768&height=1024&model=flux&nologo=true"

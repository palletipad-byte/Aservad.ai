        ...
        if user_img_prompt.strip():
            with st.spinner("⏳ అద్భుతమైన డిజైన్‌ను అత్యున్నత నాణ్యతతో రూపం ఇస్తున్నాం... దయచేసి వేచి ఉండండి."):
                try:
                    ...
                    # 🎯 కార్టూన్ రాకుండా పూర్తిగా రియలిస్టిక్ ఫోటో కోసం ప్రత్యేకమైన కమాండ్స్
                    base_prompt = f"Professional photography, real human model, {user_img_prompt}, highly detailed skin texture, pores, 8k resolution, DSLR camera shot, natural lighting, photorealistic, no cartoon, no painting."
                    encoded_prompt = urllib.parse.quote(base_prompt)
                    
                    # 📱 మొబైల్ స్క్రీన్ కోసం పర్ఫెక్ట్ 9:16 వర్టికల్ సైజు మరియు మోడల్ మార్పు
                    img_url = f"https://image.pollinations.ai/prompt/{encoded_prompt}?width=768&height=1024&model=flux-realism&nologo=true"

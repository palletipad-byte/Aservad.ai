...
# 4. AI అడ్వాన్స్‌డ్ ఇమేజ్ జనరేటర్ (Aservad.ai Ultra-HD FLUX Engine - PRO Version)
    ...
    user_img_prompt = st.text_area(
        ...
        placeholder="ఉదాహరణకు: A stunning, ultra-realistic photorealistic cinematic portrait of Nayanthara..."
    )
        ...
        if user_img_prompt.strip():
            with st.spinner("⏳ అద్భుతమైన డిజైన్‌ను అత్యున్నత నాణ్యతతో రూపం ఇస్తున్నాం... దయచేసి వేచి ఉండండి."):
                try:
                    ...
                    base_prompt = f"Raw photography, real human face, {user_img_prompt}, sharp focus, highly detailed real skin texture, pores, professional color grading, 8k resolution, shot on 35mm lens, photorealistic masterpiece."
                    encoded_prompt = urllib.parse.quote(base_prompt)
                    
                    # 📱 మొబైల్ స్క్రీన్ కోసం పర్ఫెక్ట్ 9:16 వర్టికల్ సైజు (Google AI లాగా క్లియర్ కట్ ఫ్రేమ్)
